...
function get_gen($table,$val){
	global $ConnectDB;
		$sql = "SELECT * FROM `".$table."` WHERE `user_id`='".$val."' LIMIT 0,1 ";
...
function get_user_data($table,$val){
	global $ConnectDB;
	if($table=='personnel'){
			$sql = "SELECT `phone`,`name_title`, `email` FROM `".$table."` WHERE `user_id`='".$val."' LIMIT 0,1 ";
	}else if($table=='alumni'){
			$sql = "SELECT `study_scale`,`name_title`, `phone`, `email` FROM `".$table."` WHERE `user_id`='".$val."' LIMIT 0,1 ";
	}
	else{
			$sql = "SELECT `study_scale`, `phone`, `email` FROM `".$table."` WHERE `user_id`='".$val."' LIMIT 0,1 ";
...
function getcat_name_byid($val){
	global $ConnectDB;
		$sql = "SELECT * FROM `activity_type` WHERE `id`='".$val."' ORDER BY `id` ASC ";
		$result = mysqli_query($ConnectDB,$sql);
		$nums = mysqli_num_rows($result);
                    $result=mysqli_query($ConnectDB,$sql);
                    $nums = mysqli_num_rows($result);
